...
import com.github.unidbg.linux.android.dvm.api.Thread;
    ...
    public DvmObject<?> callObjectMethodV(BaseVM vm, DvmObject<?> dvmObject, String signature, VaList vaList) {
        switch (signature) {
            ...
            case "java/lang/Thread->currentThread()Ljava/lang/Thread;": {
                return new Thread(vm, signature);
            }
            case "android/content/ContentResolve": {
                return new ContentResolve(vm, signature);
            }
            case "android/content/ContentResolver->call(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;": {
                ...
                pro.setProperty("__MTA_DEVICE_INFO__", "aabb123456");
                return new Bundle(vm, pro);
            }
            case "android/os/Bundle->getString(Ljava/lang/String;)Ljava/lang/String;": {
                return new StringObject(vm, "aabb123456");
            }
            case "java/net/NetworkInterface->getHardwareAddress()[B": {
                return new ByteArray(new byte[]{26, (byte) 0xB9, 15, (byte) 0x1E, (byte) 128, (byte) 128});
            }
        }
    ...
    public DvmObject<?> callStaticObjectMethodV(BaseVM vm, DvmClass dvmClass, String signature, VaList vaList) {
        switch (signature) {
            ...
            case "android/net/Uri->parse(Ljava/lang/String;)Landroid/net/Uri;": {
                ...
                return new DvmObject<>(vm.resolveClass("java/net/Uri"), null);

            }

            case "android/provider/Settings$Secure->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;": {

                return new StringObject(vm, "1234567890");

            }
            case "java/net/NetworkInterface->getByName(Ljava/lang/String;)Ljava/net/NetworkInterface;": {
                NetworkInterface interfaces = null;
                try {
                    interfaces = NetworkInterface.getByIndex(0);

                } catch (Exception e) {

                }
                return new DvmObject<>(vm.resolveClass("java/net/NetworkInterface"), interfaces);
            }
            case "com/ss/sys/ces/a->njss(ILjava/lang/Object;)Ljava/lang/Object;": {
                int i1 = vaList.getInt(0);
                System.out.println("内部调用数值："+i1);
                if (i1 == 131) {
                    return new StringObject(vm, "eyJvcyI6IkFuZHJvaWQiLCJ2ZXJzaW9uIjoiMS4wLjMiLCJ0b2tlbl9pZCI6IiIsImNvZGUiOjUwNH0==");
                } else if (i1 == 130) {
                    return new StringObject(vm, "00:00:00:00:00:00[<!>]TP-LINK_49lnLeA[<!>]2026350784[<!>]");
                } else if (i1 == 124) {
                    return new StringObject(vm, "[]");
                } else if (i1 == 125) {
                    return new StringObject(vm, "113.4363886,22.382336");
                } else if (i1 == 129) {
                    return new StringObject(vm, "420[<!>]1080*1794[<!>]");
                } else if (i1 == 126) {
                    return new StringObject(vm, "2600");
                } else if (i1 == 120) {
                    return new StringObject(vm, "{\"core\":6,\"hw\":\"MT6795\",\"max\":\"1440000\",\"min\":\"384000\",\"ft\":\"fp asimd evtstrm aes pmull sha1 sha2 crc32 wp half thumb fastmult vfp edsp neon vfpv3 tlsi vfpv4 idiva idivt\"}");
                } else if (i1 == 127) {
                    return new StringObject(vm, "357710060743807");
                } else if (i1 == 128) {
                    return new StringObject(vm, "460020862550230");
                } else if (i1 == 122) {
                    return new StringObject(vm, "GMT+08:00");
                } else if (i1 == 121) {
                    return new StringObject(vm, "zh_CN");
                } else if (i1 == 134) {
                    return new StringObject(vm, "-0.1, 0.6, -9.8");
                } else if (i1 == 133) {
                    return new StringObject(vm, "{}");
                } else if (i1 == 0x88) {
                    return new ByteArray(new byte[]{});
                }
                return new ArrayObject(new StringObject(vm, ""));
            }
        }
